...
@interface MutationTableViewController ()
...
- (void)initBaseData {
    ...
    UIBarButtonItem *barButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"Mutation" style:UIBarButtonItemStylePlain target:self action:@selector(mutation)];
